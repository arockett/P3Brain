...
const string& AbstractBrain::brainTypeStr = Parameters::register_parameter("brainType", (string) "Markov", "brain to be used in evolution loop, [Markov, Wire, Human]", "BRAIN");  // string parameter for outputMethod;
