...
GPGate::GPGate(shared_ptr<Genome> genome, int genomeIndex) {
  ...
  myGateType = genome->extractValue(genomeIndex, {0,8}, Genome::DATA_CODE);//genome->sites[(genomeIndex++) % genome->sites.size()] % 8;
  myValues.clear();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      V.I = (V.I << (int) 8) + genome->extractValue(genomeIndex, {0,8}, Genome::DATA_CODE);
    }
