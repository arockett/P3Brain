...
// Example problem where each pair of indices (0-1, 2-3, ... ) must both be
// the same
class MatchMaker : public Evaluator
{
public:
    MatchMaker( Configuration& config, int run_number ) :
        group_size( config.get<int>( "group_size" ) )
    {
    }
