...
inline double getDouble(const double lower, const double upper, generator& gen =
                            getCommonGenerator()) {
...
// result is in [0, 9.5)
inline double getDouble(const double upper, generator& gen =
                            getCommonGenerator()) {
...
// result is in [7, 9]
inline int getInt(const int lower, const int upper, generator& gen =
                      getCommonGenerator()) {
...
inline int getIndex(const int container_size, generator& gen =
                        getCommonGenerator()) {
